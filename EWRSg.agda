...
--           (ϕ : f γ γᴬ δ ρ) → ᴹ (sg γc γ δc δ) γᴬ
...
--           {ρc : _ᵃc {zero} (Γ.Rc γ γᴬ)}(ρ : (Γ.R γ γᴬ ᵃC) ρc)(ϕ : Γ.f γ γᴬ δ ρ)
--           (α : Set)(αᴬ : ᴬ γᴬ)(αʷ : _ᵃS {zero} (w γc α))(αᴿ : _ᵃS {zero} (R α αᴬ))(αᶠ : f γ γᴬ δ ρ α αᴬ αʷ αᴿ)
--           → ᴹ (Γ.m γ γᴬ δ ρ ϕ) (sg γ δ α αʷ) αᴬ
...
--    m   : ∀{γc}(γ : (Γ.E ᵃC) γc)(γᴬ : Γ.ᴬ){δc : _ᵃc {zero} (Γ.wc γ)}(δ : (Γ.w γ ᵃC) δc)
--           {ρc : _ᵃc {zero} (Γ.Rc γ γᴬ)}(ρ : (Γ.R γ γᴬ ᵃC) ρc)(ϕ : Γ.f γ γᴬ δ ρ)
--           (α : (E ᵃP) γc)(αᴬ : ᴬ γᴬ)(αʷ : (w γ α ᵃP) δc)(αᴿ : (R γ α αᴬ ᵃP) ρc) → ᴹ (Γ.m γ γᴬ δ ρ ϕ) (sg γ δ α αʷ) αᴬ
...
Γ ▶S B = record { ᴬ   = Σ Γ.ᴬ B.ᴬ ;
                  ...
                  m   = λ { {γc , α} γ (γᴬ , αᴬ) {δc , αʷ} δ {ρc , αᴿ} ρ (ϕ , αᶠ) → Γ.m γ γᴬ δ ρ ϕ , B.m γ γᴬ δ ρ ϕ α αᴬ αʷ αᴿ αᶠ } -} }
  where
    module Γ = Con Γ
    module B = TyS B
...
Γ ▶P A = record { ᴬ   = Σ Γ.ᴬ A.ᴬ ;
                  ...
                  m   = λ { (γ , α) (γᴬ , αᴬ) (δ , αʷ) (ρ , αᴿ) ϕ → Γ.m γ γᴬ δ ρ ϕ , A.m γ γᴬ δ ρ ϕ α αᴬ αʷ αᴿ } -} }
  where
    module Γ = Con Γ
    module A = TyP A
