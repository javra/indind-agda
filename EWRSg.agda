...
record Con : Set₂ where
  field
    ...
    f   : ∀{γc}(γ : (E ᵃC) γc)(γᴬ : ᴬ){δc : _ᵃc {zero} (wc γ)}(δ : (w γ ᵃC) δc){ρc : _ᵃc {zero} (Rc γ γᴬ)}(ρ : (R γ γᴬ ᵃC) ρc) → Set
    t   : ∀{γc}(γ : (E ᵃC) γc)(γᴬ : ᴬ){δc : _ᵃc {zero} (wc γ)}(δ : (w γ ᵃC) δc){ρc : _ᵃc {zero} (Rc γ γᴬ)}(ρ : (R γ γᴬ ᵃC) ρc) → Set
    sg  : (γc : Ec ᵃc)(γ : (E ᵃC) γc)(δc : _ᵃc {zero} (wc γ)) → (δ : (w γ ᵃC) δc) → ᴬ
    m   : ∀{γc}(γ : (E ᵃC) γc)(γᴬ : ᴬ){δc : _ᵃc {zero} (wc γ)}(δ : (w γ ᵃC) δc){ρc : _ᵃc {zero} (Rc γ γᴬ)}(ρ : (R γ γᴬ ᵃC) ρc)
           (ϕ : f γ γᴬ δ ρ)(τ : t γ γᴬ δ ρ) → ᴹ (sg γc γ δc δ) γᴬ
...
record TyS (Γ : Con) : Set₂ where
  ...
  field
    ...
    f   : ∀{γc}(γ : (Γ.E ᵃC) γc)(γᴬ : Γ.ᴬ){δc : _ᵃc {zero} (Γ.wc γ)}(δ : (Γ.w γ ᵃC) δc){ρc : _ᵃc {zero} (Γ.Rc γ γᴬ)}(ρ : (Γ.R γ γᴬ ᵃC) ρc)
           (α : Set)(αᴬ : ᴬ γᴬ)(αʷ : _ᵃS {zero} (w γc α))(αᴿ : _ᵃS {zero} (R α αᴬ)) → Set
    t   : ∀{γc}(γ : (Γ.E ᵃC) γc)(γᴬ : Γ.ᴬ){δc : _ᵃc {zero} (Γ.wc γ)}(δ : (Γ.w γ ᵃC) δc){ρc : _ᵃc {zero} (Γ.Rc γ γᴬ)}(ρ : (Γ.R γ γᴬ ᵃC) ρc)
           (α : Set)(αᴬ : ᴬ γᴬ)(αʷ : _ᵃS {zero} (w γc α))(αᴿ : _ᵃS {zero} (R α αᴬ)) → Set
    ...
    m   : ∀{γc}(γ : (Γ.E ᵃC) γc)(γᴬ : Γ.ᴬ){δc : _ᵃc {zero} (Γ.wc γ)}(δ : (Γ.w γ ᵃC) δc)
           ...
           (α : Set)(αᴬ : ᴬ γᴬ)(αʷ : _ᵃS {zero} (w γc α))(αᴿ : _ᵃS {zero} (R α αᴬ))(αᶠ : f γ γᴬ δ ρ α αᴬ αʷ αᴿ)(αᵗ : t γ γᴬ δ ρ α αᴬ αʷ αᴿ)
...
record TyP (Γ : Con) : Set₂ where
  ...
  field
    ...
    m   : ∀{γc}(γ : (Γ.E ᵃC) γc)(γᴬ : Γ.ᴬ){δc : _ᵃc {zero} (Γ.wc γ)}(δ : (Γ.w γ ᵃC) δc)
           {ρc : _ᵃc {zero} (Γ.Rc γ γᴬ)}(ρ : (Γ.R γ γᴬ ᵃC) ρc)(ϕ : Γ.f γ γᴬ δ ρ)(τ : Γ.t γ γᴬ δ ρ)
           (α : (E ᵃP) γc)(αᴬ : ᴬ γᴬ)(αʷ : (w γ α ᵃP) δc)(αᴿ : (R γ α αᴬ ᵃP) ρc) → ᴹ (Γ.m γ γᴬ δ ρ ϕ τ) (sg γ δ α αʷ) αᴬ
...
record TmS (Γ : Con) (B : TyS Γ) : Set₂ where
  ...
  field
    ...
    f   : ∀{γc}(γ : (Γ.E ᵃC) γc)(γᴬ : Γ.ᴬ){δc : _ᵃc {zero} (Γ.wc γ)}(δ : (Γ.w γ ᵃC) δc){ρc : _ᵃc {zero} (Γ.Rc γ γᴬ)}(ρ : (Γ.R γ γᴬ ᵃC) ρc) →
           B.f γ γᴬ δ ρ ((E ᵃt) γc) (ᴬ γᴬ) ((w γ ᵃt) δc) ((R γ γᴬ ᵃt) ρc)
    t   : ∀{γc}(γ : (Γ.E ᵃC) γc)(γᴬ : Γ.ᴬ){δc : _ᵃc {zero} (Γ.wc γ)}(δ : (Γ.w γ ᵃC) δc){ρc : _ᵃc {zero} (Γ.Rc γ γᴬ)}(ρ : (Γ.R γ γᴬ ᵃC) ρc) →
           B.t γ γᴬ δ ρ ((E ᵃt) γc) (ᴬ γᴬ) ((w γ ᵃt) δc) ((R γ γᴬ ᵃt) ρc)
    sg  : ∀{γc}(γ : (Γ.E ᵃC) γc){δc}(δ : (Γ.w γ ᵃC) δc) → ᴬ (Γ.sg γc γ δc δ) ≡ B.sg γ δ ((E ᵃt) γc) ((w γ ᵃt) δc)
    m   : ∀{γc}(γ : (Γ.E ᵃC) γc)(γᴬ : Γ.ᴬ){δc : _ᵃc {zero} (Γ.wc γ)}(δ : (Γ.w γ ᵃC) δc){ρc : _ᵃc {zero} (Γ.Rc γ γᴬ)}(ρ : (Γ.R γ γᴬ ᵃC) ρc)
           (ϕ : Γ.f γ γᴬ δ ρ)(τ : Γ.t γ γᴬ δ ρ)
           → coe (happly2 (B.ᴹ (B.Γ.m γ γᴬ δ ρ ϕ τ)) (sg γ δ) (ᴬ γᴬ)) (ᴹ (Γ.m γ γᴬ δ ρ ϕ τ))
             ≡ B.m γ γᴬ δ ρ ϕ τ ((E ᵃt) γc) (ᴬ γᴬ) ((w γ ᵃt) δc) ((R γ γᴬ ᵃt) ρc) (f γ γᴬ δ ρ) (t γ γᴬ δ ρ)
...
record Sub (Γ : Con) (Δ : Con) : Set₂ where
  ...
  field
    ...
    R   : ∀{γc}(γ : (Γ.E ᵃC) γc){γᴬ : Γ.ᴬ}{δc} → _ᵃC {zero} (Γ.R γ γᴬ) δc → (Δ.R (E γ) (ᴬ γᴬ) ᵃC) ((Rc γ γᴬ ᵃs) δc)
    f   : ∀{γc}(γ : _)(γᴬ : _){δc}(δ : _){ρc}(ρ : _) → Γ.f {γc} γ γᴬ {δc} δ {ρc} ρ → Δ.f (E γ) (ᴬ γᴬ) (w γ δ) (R γ ρ)
    t   : ∀{γc}(γ : _)(γᴬ : _){δc}(δ : _){ρc}(ρ : _) → Γ.t {γc} γ γᴬ {δc} δ {ρc} ρ → Δ.t (E γ) (ᴬ γᴬ) (w γ δ) (R γ ρ)
...
El {Γ} a = record { ᴬ   = λ γᴬ → a.ᴬ γᴬ ;
                    ...
                    m   = λ γ γᴬ δ ρ ϕ τ α αᴬ αʷ αᴿ
                            → let (αᴬ' , αᴿ') = a.t γ γᴬ δ ρ α αʷ in
                              let e = happly (a.m γ γᴬ δ ρ ϕ τ) (α , αʷ) in
                              let e' = a.f γ γᴬ δ ρ α αᴬ αᴬ' αʷ αᴿ αᴿ' in
...
ΠS {Γ} a B = record { ᴬ   = λ γᴬ → (α : a.ᴬ γᴬ) → B.ᴬ (γᴬ , α) ;
                      ...
                      m   = λ {γc} γ γᴬ {δc} δ {ρc} ρ ϕ τ π πᴬ πʷ πᴿ πᶠ πᵗ αᴬ
                              → let (xᴱ , xʷ) = coe (a.sg γ δ) αᴬ in
                                let (xᴬ , xᴿ) = a.t γ γᴬ δ ρ xᴱ xʷ in
...
appS {a = a}{B} f = record { ᴬ   = λ { (γ , α) → f.ᴬ γ α } ;
...
âppS {Γ}{T}{B} f τ = record { ᴬ  = λ γᴬ → f.ᴬ γᴬ τ ;
                              ...
                              f  = λ γ γᴬ δ ρ → f.f γ γᴬ δ ρ τ ;
                              t  = λ γ γᴬ δ ρ → f.t γ γᴬ δ ρ τ ;
...
σ ∘ δ = record { ᴬ   = λ γ → σ.ᴬ (δ.ᴬ γ) ;
                 ...
                 Ec  = σ.Ec S.∘ δ.Ec ;
                 E   = λ γ → σ.E (δ.E γ) ;
                 wc  = λ {γc} γ → σ.wc (δ.E γ) S.∘ δ.wc γ ;
                 w   = λ {γc} γ {δc} δ' → σ.w (δ.E γ) (δ.w γ δ') ;
                 Rc  = λ {γc} γ γᴬ → σ.Rc (δ.E γ) (δ.ᴬ γᴬ) S.∘ δ.Rc γ γᴬ ;
                 R   = λ {γc} γ {γᴬ} ρ → σ.R (δ.E γ) (δ.R γ ρ) ;
                 ...
                 sg  = λ {γc} γ δ' → σ.ᴬ & δ.sg _ _ ◾ σ.sg (δ.E γ) (δ.w γ δ') }
  where
    module σ = Sub σ
    module δ = Sub δ
...
_[_]tS {Γ}{Δ}{A} a σ = record { ᴬ   = λ γ → a.ᴬ (σ.ᴬ γ) ;
                                ...
                                f   = λ γ γᴬ δ ρ → a.f (σ.E γ) (σ.ᴬ γᴬ) (σ.w γ δ) (σ.R γ ρ) ;
                                t   = λ γ γᴬ δ ρ → a.t (σ.E γ) (σ.ᴬ γᴬ) (σ.w γ δ) (σ.R γ ρ) ;
                                sg  = λ {γc} γ {δc} δ →
                                              apd a.ᴬ (σ.sg γ δ ⁻¹) ⁻¹
                                              ◾ coe (A.ᴬ & (σ.sg γ δ ⁻¹))
                                                & (a.sg (σ.E γ) (σ.w γ δ)) ;
...
σ ,tS t = record { ᴬ   = λ γ → σ.ᴬ γ , t.ᴬ γ ;
                   ...
                   R   = λ γ δ → σ.R γ δ ;
                   f   = λ γ γᴬ δ ρ x → σ.f γ γᴬ δ ρ x , t.f γ γᴬ δ ρ ;
                   t   = λ γ γᴬ δ ρ x → σ.t γ γᴬ δ ρ x , t.t γ γᴬ δ ρ ;
